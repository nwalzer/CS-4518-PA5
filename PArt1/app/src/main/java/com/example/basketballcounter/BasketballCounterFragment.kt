...
class BasketballCounterFragment() : Fragment() {
    ...
    override fun onStart() {
        ...
        teamACamera.apply {
            ...
            /* NOTE: THE PROFESSOR TOLD US TO COMMENT OUT THIS LINE TO MAKE THE CAMERA WORK ON OUR AVDs
    ...
    private fun updatePhotoView(isA: Boolean){
        Log.d(TAG, "${photoFileA.exists()} and ${photoFileB.exists()} and checking $isA")
        if(isA){
